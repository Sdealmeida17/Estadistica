...
public class PassengerLocationDtoValidationTest {
    ...
    void shouldFailValidationWhenCoordinateIsNull() {
        PassengerLocationDto passengerLocationDto = new PassengerLocationDto();
        passengerLocationDto.setCoordinate(null);
        passengerLocationDto.setDescription("Description");
        Set<ConstraintViolation<PassengerLocationDto>> violations = validator.validate(passengerLocationDto);
    ...
    void shouldFailValidationWhenCoordinateLatitudeIsTooLow() {
        ...
        PassengerLocationDto passengerLocationDto = new PassengerLocationDto();
        passengerLocationDto.setCoordinate(invalidCoordinate);
        passengerLocationDto.setDescription("Description");
        Set<ConstraintViolation<PassengerLocationDto>> violations = validator.validate(passengerLocationDto);
        assertEquals(1, violations.size());
    }
